...
// ----------------------------- Spread Operator (...)
// Note: Spread operator (...) is used on the right hand side of the assignment operator (the =)
const arr2 = [7, 8, 9];
...
// Note: The spread operayor works on all iterables but not objects
// Iterables are arrays, string, map or set. NOT object
const str = "Jonas";
const letters = [...str, " ", "S."];
console.log(letters);
console.log(...str);
...
// Objects (using spread operator on objects was implemented in 2018)
const newRestaurant = {
   foundedIn: 1998,
   ...restaurant,
   founder: "Guiseppe",
...
// Rest pattern looks like the spread operator but it does the opposite of the spread operator
// Note: Rest pattern (...) is used on the left hand side of the assignment operator (the =)

// ----------- 1. Desturcturing
// SPREAD operator because ... is on the RIGHT side of =
const arr4 = [1, 2, ...[3, 4]];
...
// Rest pattern collects all the array elements after the last variable. It doesn't include any skipped elements
