...
const calcAverageHumanAge = function (ages) {
  ...
  console.log('Dog Age: ', dogAge1);

  const adultDogs = humanAge.filter(item => item >= 18);
  console.log('Adult Dog: ', adultDogs);

  const theAverage =
    adultDogs.reduce((acc, c) => acc + c, 0) / adultDogs.length;
  console.log('The Average: ', theAverage);
};
